...
<head>
    ...
    <title>Manage Appointments - Specialist Portal</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="wrapper d-flex align-items-stretch">
     ...
     <?php
        ...
        <!-- Page Content  -->
        <div id="content">
            <nav class="navbar navbar-expand-lg navbar-light bg-light dashboard-header mb-4">
            ...
            <div class="container-fluid">
                <h2 class="mb-4"><i class="fas fa-calendar-check mr-2"></i>Manage Appointments</h2>
